...
for (let counter19 = 1; counter19 <= 20; counter19 += 1) {
    const Bonus1Div = document.createElement('Div')
    let greyBoxes = document.getElementsByClassName('.grey-boxes')
    mainElement.append(Bonus1Div)
    Bonus1Div.append(greyBoxes)
}